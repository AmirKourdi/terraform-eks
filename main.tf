...
#  version = "v2.18.0"
#  name    = "eks-str-tlv-vpc"
#  cidr    = "172.20.0.0/16" 

#  azs             = ["eu-central-1a", "eu-central-1b", "eu-central-1c"]
#  public_subnets  = ["172.20.1.0/24", "172.20.2.0/24", "172.20.3.0/24"]
#  private_subnets = ["172.20.64.0/19", "172.20.96.0/19", "172.20.128.0/19"]
#   private_subnets  = ["172.20.10.0/26","172.20.14.0/27","172.20.5.0/26"]
...
resource "null_resource" "run_ansible" {
  ...
  provisioner "local-exec" {
    command = "aws eks update-kubeconfig --region eu-central-1 --name eks-srt-dev-tlv-akourdi; ansible-playbook ansible/configure_eks.yaml"
