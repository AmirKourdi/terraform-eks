...
variable "cluster_name" {
  ...
  type        = string
  default     = "eks-srt-dev-tlv-akourdi"
}
...
variable "subnet_ids" {
  ...
  type        = list(string)
#  default     = ["subnet-0b20d4c21aef1fdf1", "subnet-0b413498292a308ff", "subnet-0db57556e34ffc17c"]
  default     = ["subnet-003d1bccfc14b718a","subnet-067f8c6b550c9a513"]
}
...
variable "cluster_security_group_name" {
  ...
  type        = string
  default     = "aks-srt-tlv-sg-akourdi"
}
